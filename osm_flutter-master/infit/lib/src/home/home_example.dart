...
class _MainExampleState extends State<MainExample> with OSMMixinObserver {
  ...
  Future<String> roadActionBt(BuildContext ctx) async {
    String a = "";
    try {
      ...
      print("this is the contact point2 : $point2");
      ...
      await bottomPersistant.closed.then((roadType) async {
        ...
        a = "distance:${roadInformation.distance}Km";
        print(
