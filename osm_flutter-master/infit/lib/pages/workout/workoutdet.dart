...
import 'package:infit/pages/finish/finish.dart';
import 'package:infit/services/db_class_model.dart';
import 'package:flutter/material.dart';
import 'package:infit/pages/break.dart';
import 'package:provider/provider.dart';

class WorkOutDet extends StatefulWidget {
  const WorkOutDet({super.key});

  @override
  State<WorkOutDet> createState() => _WorkOutDetState();
}

class _WorkOutDetState extends State<WorkOutDet> {
  int id = 0;
  var index = 0;
