...
import 'package:infit/pages/startup/Startup_h.dart';
import 'package:infit/pages/finish/finishw.dart';
...
class WorkOutDeth extends StatefulWidget {
  const WorkOutDeth({super.key});

  @override
  State<WorkOutDeth> createState() => _WorkOutDetState();
}

class _WorkOutDetState extends State<WorkOutDeth> {
  int id = 0;
  var index = 0;
